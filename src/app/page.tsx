...
export default function LandingPage() {
      ...
      features={[
        {
          ...
          imageAlt: "Car getting a foam wash, close up of bubbles",
        },
        {
          id: "s2",
          ...
          imageAlt: "Clean car interior, sparkling dashboard",
        },
        {
          id: "s3",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-man-swapping-wheel_23-2148254116.jpg",
          imageAlt: "Shiny car wheel after professional cleaning",
        },
        {
          id: "s4",
          ...
          imageAlt: "Buffing machine on car paint, removing swirl marks",
        },
      ]}
  ...
  <div id="packages" data-section="packages">
      ...
      products={[
        {
          id: "p1",
          name: "The Quick Glaze",
          price: "$99",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-car-care-process_23-2149193627.jpg",
          imageAlt: "Basic car wash with a quick glaze finish",
        },
        {
          id: "p2",
          name: "The Executive Shine",
          price: "$249",
          imageSrc: "http://img.b2bpic.net/free-photo/two-stylish-women-car-salon_1157-20863.jpg",
          imageAlt: "Premium car interior detailing",
        },
        {
          id: "p3",
          name: "The Ultimate Transformation",
          price: "$499",
          imageSrc: "http://img.b2bpic.net/free-photo/car-wrapping-with-foil-car-service_1303-32341.jpg",
          imageAlt: "Supercar getting ceramic coating",
        },
        {
          id: "p4",
          ...
          imageAlt: "Detailed car cabin with clean seats",
        },
        {
          id: "p5",
          ...
          imageAlt: "Car exterior after professional wash and wax",
        },
        {
          id: "p6",
          ...
          imageAlt: "Close-up of clean car wheel",
        },
      ]}
      ...
      plans={[
        {
          ...
          price: "$99",
          subtitle: "Essential clean-up for daily drivers.",
          buttons: [
            {
              text: "Select Basic",
              href: "#contact",
        ...
        },
        {
          ...
          badgeIcon: Star,
          price: "$249",
          subtitle: "Deep clean and protection for a lasting shine.",
          buttons: [
            {
              text: "Select Pro",
              href: "#contact",
        ...
        },
        {
          ...
          badgeIcon: Diamond,
          price: "$499",
          subtitle: "The ultimate transformation for enthusiasts.",
          buttons: [
            {
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          handle: "@ShinySarah",
          testimonial: "Absolutely blown away! My car looks better than it did the day I drove it off the lot. Detailing Brat is simply the best.",
          imageSrc: "http://img.b2bpic.net/free-photo/confident-successful-middle-aged-business-leader_1262-4872.jpg",
          imageAlt: "Smiling woman, satisfied customer",
        },
        {
          id: "t2",
          name: "Mark P.",
          handle: "@DetailFreak",
          testimonial: "The paint correction was phenomenal. Every swirl mark gone, replaced by an incredible depth of shine. True artists!",
          imageSrc: "http://img.b2bpic.net/free-photo/smiley-woman-enjoying-road-trip-her-car_23-2148801471.jpg",
          imageAlt: "Man giving thumbs up next to his clean car",
        },
        {
          id: "t3",
          name: "Emily R.",
          handle: "@CarLover",
          testimonial: "My interior feels brand new. Every crevice, every surface, impeccably clean. It's like a spa day for my car!",
          imageSrc: "http://img.b2bpic.net/free-photo/man-white-shirt-wipes-car-car-wash_1157-27341.jpg",
          imageAlt: "Woman pointing at her car's shine",
        },
        {
          id: "t4",
          name: "David K.",
          handle: "@SpeedDemon",
          testimonial: "Quick, efficient, and incredibly detailed. They respect your time and deliver outstanding results every single time. Highly recommend!",
          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-with-pen-table_23-2147844684.jpg",
          imageAlt: "Happy man with car keys",
        },
        {
          id: "t5",
          name: "Jessica L.",
          handle: "@LuxuryRides",
          testimonial: "I trust Detailing Brat with all my luxury vehicles. Their ceramic coating is top-tier and lasts for months. Unmatched quality!",
      ...
      faqs={[
        {
          ...
          content: "Most of our standard detailing packages can be completed within 2-4 hours. More intensive services like paint correction or ceramic coating may require a full day or overnight.",
        },
        {
          id: "faq2",
          title: "What's the difference between a wash and a detail?",
          content: "A wash is a superficial clean, while a detail is a thorough, systematic cleaning and restoration process of your vehicle, both inside and out, aiming to bring it back to its best possible condition.",
        },
        {
          id: "faq3",
          title: "Do I need to book an appointment in advance?",
          content: "Yes, we highly recommend booking an appointment to ensure we can dedicate the proper time and resources to your vehicle. Walk-ins are subject to availability.",
        },
        {
          id: "faq4",
          title: "What products do you use for detailing?",
          content: "We only use premium, professional-grade detailing products that are safe for your vehicle's surfaces and effective in delivering a superior clean and lasting protection.",
        },
        {
          id: "faq5",
          title: "Do you offer mobile detailing services?",
          content: "Currently, we operate from our state-of-the-art detailing studio to ensure optimal conditions for all services. Mobile services may be introduced in the future.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      textarea={{
        name: "message",
        placeholder: "Tell us about your car and needs...",
        rows: 4,
      }}
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Email Us",
              href: "mailto:info@detailingbrat.com",
            },
            {
              label: "Call Us",
              href: "tel:+1234567890",
